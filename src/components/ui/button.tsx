...
// Merged with cn() so conflicting classes resolve (e.g. the base
// border-transparent vs. outline's border-border) when these classes are put
// on a Link instead of a Button.
